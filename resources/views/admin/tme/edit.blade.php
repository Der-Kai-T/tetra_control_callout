...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <form action="/admin/tme/{{$tme->id}}/edit" method="POST">
                @csrf
                @method("PATCH")
                <x-panels.card>
